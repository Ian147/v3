...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Ian147/v3/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Ian147/v3/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Ian147/v3/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Ian147/v3/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Ian147/v3/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Ian147/v3/main/ip | grep $ipsaya | awk '{print $3}')
...
function menu(){
    ...
    wget -q https://raw.githubusercontent.com/Ian147/v3/main/kikitolan/mukung/menu.zip
    unzip menu.zip
    chmod +x menu/*
